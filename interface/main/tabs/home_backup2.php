...
<body>
    <div class="landing-container">
        ...
        <div class="icon-grid">
            <!-- Calendar -->
		<a href="<?php echo $GLOBALS['webroot']; ?>/interface/main/restoreSession.php?token_main=<?php echo urlencode($token_main); ?>&redirect=interface/main/calendar/index.php"
		   class="icon-card">
            ...
            <a href="<?php echo $GLOBALS['webroot']; ?>/interface/super/edit_globals.php?token_main=<?php echo urlencode($token_main); ?>"
               class="icon-card">
                ...
                <div class="icon-description">System settings and config</div>
            </a>
            <?php } ?>
        </div>
    </div>
